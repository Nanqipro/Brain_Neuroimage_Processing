...
class PathConfig:
    ...
    def __init__(self):
        ...
        self.default_data_file = "no.2980240924openfield_CellVideo0_corrected_0_cell_trace.csv"  # 默认数据文件名
        ...
        self.effect_sizes_filename = "effect_sizes_no.2980240924openfield_CellVideo0_corrected_0_cell_trace.csv"  # 效应量结果文件名
