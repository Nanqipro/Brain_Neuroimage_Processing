...
# correspondence_table = pd.read_excel('./data/神经元对应表.xlsx')
#
# # 根据对应表准备数据
...
# # Day3 trace 图
# plt.subplot(1, 3, 1)
# for neuron_label in neuron_labels_day3:
#     if neuron_label is not None:
#         plt.plot(time_stamps, aligned_day3_df[neuron_label], label=neuron_label)
# plt.title('Day3')
...
# # Day6 trace 图
# plt.subplot(1, 3, 2)
# for neuron_label in neuron_labels_day6:
#     if neuron_label is not None:
#         plt.plot(time_stamps, aligned_day6_df[neuron_label], label=neuron_label)
# plt.title('Day6')
# plt.xlabel('Time Stamp')
# plt.legend(loc='upper right', bbox_to_anchor=(1.15, 1))
# plt.ylabel('')
...
# # Day9 trace 图
# plt.subplot(1, 3, 3)
# for neuron_label in neuron_labels_day9:
#     if neuron_label is not None:
#         plt.plot(time_stamps, aligned_day9_df[neuron_label], label=neuron_label)
# plt.title('Day9')
# plt.xlabel('Time Stamp')
# plt.legend(loc='upper right', bbox_to_anchor=(1.15, 1))
# plt.ylabel('')
...
#     # Day3 数据和标签；若为 null 则填充 NaN 并添加空标签
#     if pd.notna(day3_neuron) and day3_neuron in day3_data.columns:
#         aligned_day3.append((day3_data[day3_neuron] - day3_data[day3_neuron].mean()) / day3_data[day3_neuron].std())
#         neuron_labels_day3.append(day3_neuron)
#     else:
#         aligned_day3.append(pd.Series([np.nan] * len(day3_data)))
#         neuron_labels_day3.append(None)
...
#     # Day6 数据和标签；若为 null 则填充 NaN 并添加空标签
#     if pd.notna(day6_neuron) and day6_neuron in day6_data.columns:
#         aligned_day6.append((day6_data[day6_neuron] - day6_data[day6_neuron].mean()) / day6_data[day6_neuron].std())
#         neuron_labels_day6.append(day6_neuron)
#     else:
#         aligned_day6.append(pd.Series([np.nan] * len(day6_data)))
#         neuron_labels_day6.append(None)
...
#     # Day9 数据和标签；若为 null 则填充 NaN 并添加空标签
#     if pd.notna(day9_neuron) and day9_neuron in day9_data.columns:
#         aligned_day9.append((day9_data[day9_neuron] - day9_data[day9_neuron].mean()) / day9_data[day9_neuron].std())
#         neuron_labels_day9.append(day9_neuron)
#     else:
#         aligned_day9.append(pd.Series([np.nan] * len(day9_data)))
#         neuron_labels_day9.append(None)
