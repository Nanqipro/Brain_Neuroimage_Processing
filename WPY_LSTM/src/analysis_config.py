...
class AnalysisConfig:
    ...
    def __init__(self) -> None:
        ...
        self.data_file = '/home/torpedo/Workspace/Brain_Neuroimage_Processing/LSTM/datasets/processed_EMtrace.xlsx' # 指向高架环境数据
        ...
        # self.test_size: float = 0.2        # 旧的测试集比例，现用于定义(验证集+测试集)总比例
