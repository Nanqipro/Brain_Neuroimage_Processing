...
file_path = './data/smoothed_normalized_trace_homecage.xlsx'
...
for i in range(1, 52):
    plt.plot(df['stamp'], df[f'n{i}'] * scaling_factor + i * 20, label=f'n{i}')  # Scaling and vertical stacking
