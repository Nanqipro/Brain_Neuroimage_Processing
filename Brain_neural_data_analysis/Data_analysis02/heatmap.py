...
#
# # 将列表转换为 DataFrame，并设置神经元标签，确保标签对齐
...
# # Day3 热图
# plt.subplot(1, 3, 1)
# sns.heatmap(aligned_day3_df, cmap='viridis', cbar=True)
# plt.title('Day3')
# plt.xlabel('neural')
# plt.ylabel('stamp')
#
# # Day6 热图
# plt.subplot(1, 3, 2)
# sns.heatmap(aligned_day6_df, cmap='viridis', cbar=True)
# plt.title('Day6')
# plt.xlabel('neural')
# plt.ylabel('')
#
# # Day9 热图
# plt.subplot(1, 3, 3)
# sns.heatmap(aligned_day9_df, cmap='viridis', cbar=True)
# plt.title('Day9')
# plt.xlabel('neural')
# plt.ylabel('')
#
...
# Day3 热图
plt.subplot(1, 3, 1)
sns.heatmap(aligned_day3_df.T, cmap='viridis', cbar=True)  # 转置 DataFrame 以调换横纵坐标
plt.title('Day3')
plt.xlabel('stamp')
plt.ylabel('neural')
...
# Day6 热图
plt.subplot(1, 3, 2)
sns.heatmap(aligned_day6_df.T, cmap='viridis', cbar=True)  # 转置 DataFrame 以调换横纵坐标
plt.title('Day6')
plt.xlabel('stamp')
plt.ylabel('')
...
# Day9 热图
plt.subplot(1, 3, 3)
sns.heatmap(aligned_day9_df.T, cmap='viridis', cbar=True)  # 转置 DataFrame 以调换横纵坐标
plt.title('Day9')
plt.xlabel('stamp')
plt.ylabel('')
