...
当前共有 **11个模型** 可用于实验：4个基础模型 + 7个先进模型
...
| 模型 | 参数 | 论文年份 | 特点 | 优势 |
|------|------|---------|------|------|
| **PNA** | `--model pna` | NeurIPS 2020 | 多聚合器组合 | OGB SOTA，表达能力强 |
| **GATv2** | `--model gatv2` | ICLR 2022 | 改进的注意力机制 | 动态注意力，优于GAT |
| **DeeperGCN** | `--model deepergcn` | ICLR 2020 | 深层网络（7-14层） | 残差连接，大感受野 |
