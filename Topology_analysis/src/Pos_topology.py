...
# 1. 数据读取
neuron_data = pd.read_excel('../datasets/Day6_with_behavior_labels_filled.xlsx')  # 请修改为您的数据路径

# 获取神经元ID列表
neuron_ids = [col for col in neuron_data.columns if 'n' in col.lower()]
...
# 读取先前标注的坐标数据
positions_data = pd.read_csv('../datasets/Day6_Max_position.csv')
...
# 将本地图片转换为 base64 编码
image_path = '../datasets/Day6_Max.png'  # 替换为你的图片路径
...
# 最后再输出HTML
fig.write_html('../graph/Day6_pos_topology.html')