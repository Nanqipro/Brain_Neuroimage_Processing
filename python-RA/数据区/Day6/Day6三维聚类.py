...
#     ax.scatter(features_scaled[indices, 0], features_scaled[indices, 1], features_scaled[indices, 2],
...
#
# # 使用 bbox_to_anchor 将图例放在右侧外部
# ax.legend(bbox_to_anchor=(1.1, 1), loc='upper left', title="Clusters")
# plt.title('3D KMeans Clustering of Neurons Based on Calcium Signal Features')
# plt.show()
